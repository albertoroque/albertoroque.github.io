...
.controller('AdmLojaCtrl', function ($scope, $rootScope, $location, $routeParams, $mdDialog, AdmLojaService, AdmProdutoService, AuthStore) {
    ...
    $scope.editarProduto = function (idproduto) {
        $rootScope.irPara("/loja/1/produto/" + idproduto + "/editar", "_self");
    }
    ...
    $scope.desativarProduto = function (idproduto) {
        ...
        AdmProdutoService.desativarProduto(idproduto)
        .then(function (result) {
            $scope.carregaProdutos();
            $rootScope.showToast('Produto desativado com sucesso!');            
        })
        .catch(function (result){            
        })       
    }
...
.controller('PublicacaoCtrl', function ($scope, $rootScope, $mdDialog, $routeParams, $mdToast, AdmLojaService, AuthStore, LocationService) {
